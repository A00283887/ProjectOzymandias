...
public class Shotgun : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        hips = GameObject.Find("Hips").GetComponent<Rigidbody2D>();
    ...
    void Update()
    {
        ...
        if (bullets >= 1 && Input.GetMouseButton(1) && Input.GetMouseButton(0) && canShoot == true)
        {
            ...
            Rigidbody2D bulletInstance1 = Instantiate(gameObj, barrell.position, Quaternion.Euler(new Vector3(0, 0, (weapon.eulerAngles.z) - 90))) as Rigidbody2D;
            Rigidbody2D bulletInstance2 = Instantiate(gameObj, barrell.position, Quaternion.Euler(new Vector3(0, 0, (weapon.eulerAngles.z) - 90))) as Rigidbody2D;
            Rigidbody2D bulletInstance3 = Instantiate(gameObj, barrell.position, Quaternion.Euler(new Vector3(0, 0, (weapon.eulerAngles.z) - 90))) as Rigidbody2D;
            Rigidbody2D bulletInstance4 = Instantiate(gameObj, barrell.position, Quaternion.Euler(new Vector3(0, 0, (weapon.eulerAngles.z) - 90))) as Rigidbody2D;

            bulletInstance.velocity = new Vector2(shootDirection.x * speed, (shootDirection.y + Random.Range(-5,5)) * speed);
            bulletInstance1.velocity = new Vector2(shootDirection.x * speed, (shootDirection.y + Random.Range(-5, 5)) * speed);
            bulletInstance2.velocity = new Vector2(shootDirection.x * speed, (shootDirection.y + Random.Range(-5, 5)) * speed);
            bulletInstance3.velocity = new Vector2(shootDirection.x * speed, (shootDirection.y + Random.Range(-5, 5)) * speed);
            bulletInstance4.velocity = new Vector2(shootDirection.x * speed, (shootDirection.y + Random.Range(-5, 5)) * speed);

            arm.velocity = new Vector2(0,10);
            hips.velocity = new Vector2(-shootDirection.x * speed*2, -shootDirection.y * speed*2);
            canShoot = false;
            canSwitch = false;
            bullets--;
