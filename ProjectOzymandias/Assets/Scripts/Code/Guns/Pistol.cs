...
public class Pistol : MonoBehaviour
{
    ...
    private EnemyShooting es2;
    private EnemyShooting es3;
    private EnemyShooting es4;
    private GameObject eGun;
    private Balance bal;
    private Balance bal2;
    private Balance bal3;
    private Balance bal4;
    private Balance bal5;
    private Balance bal6;
    private Balance bal7;
    ...
    void Start()
    {
        ...
        es = GameObject.Find("LeftHandEnemy").GetComponent<EnemyShooting>();
        es2 = GameObject.Find("RightHandEnemy").GetComponent<EnemyShooting>();
        es3 = GameObject.Find("LeftArmEnemy").GetComponent<EnemyShooting>();
        es4 = GameObject.Find("RightArmEnemy").GetComponent<EnemyShooting>();
        bal = GameObject.Find("HipsEnemy").GetComponent<Balance>();
        bal2 = GameObject.Find("HeadEnemy").GetComponent<Balance>();
        bal3 = GameObject.Find("BodyEnemy").GetComponent<Balance>();
        bal4 = GameObject.Find("LeftLegEnemy").GetComponent<Balance>();
        bal5 = GameObject.Find("RightLegEnemy").GetComponent<Balance>();
        bal6 = GameObject.Find("LeftFootEnemy").GetComponent<Balance>();
        bal7 = GameObject.Find("RightFootEnemy").GetComponent<Balance>();
    ...
    void Update()
    {
        ammo.text = Pistolbullets.ToString();
        ...
        if (Pistolbullets >= 1 && Input.GetMouseButton(1) && Input.GetMouseButtonDown(0) && canShoot == true)
        {
